...
def realizaReqCambio():
    ...
    if response.status_code == 200:
        ...
        return dados_alta,dados_baixa,dados_var,dados_timestamp,dados_create_date,dados_cotacao
        

    else:
        print("Erro ao fazer a requisição:", response.status_code)

dados_alta,dados_baixa,dados_var,dados_timestamp,dados_create_date,dados_cotacao = realizaReqCambio()
